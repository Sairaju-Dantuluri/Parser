...
# This import is required to use commandline argument for filename to be lexed.
import sys
# Importing the Tokenizer class custom written by us (the team)
...
while True:
    ...
    print("< " + token.token + ", " + token.lexeme + " >  b/w indices " + str(token.begin) +
          " to " + str(token.end) + " on line number " + str(token.line) + "\n")
